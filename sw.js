const CACHE = 'wills-warehouse-shell-v0.4.8-hpp-decimal-fix';
const ASSETS = [
  './','./index.html','./app.css?v=0.4.8','./config.js?v=0.4.8','./bridge.js?v=0.4.8','./app.js?v=0.4.8','./manifest.webmanifest',
