const CACHE = 'wills-warehouse-shell-v0.6.5-guided-receipt-dynamic-outlet-fast-ux';
const ASSETS = [
  './','./index.html','./app.css?v=0.6.5','./config.js?v=0.6.5','./bridge.js?v=0.6.5','./app.js?v=0.6.5','./manifest.webmanifest',
