const CACHE = 'wills-warehouse-shell-v0.4.4-source-master-unit-purchase-guard';
const ASSETS = [
  './','./index.html','./app.css?v=0.4.4','./config.js?v=0.4.4','./bridge.js?v=0.4.4','./app.js?v=0.4.4','./manifest.webmanifest',
